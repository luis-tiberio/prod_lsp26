...
def get_data(page):
    ...
    try:
        # Primeiro link
        page.goto("https://spx.shopee.com.br/#/dashboard/toProductivity?page_type=Inbound")
        ...
        first_value = page.inner_text('xpath=/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[2]/div[1]/div/div[2]/div/div[1]/div[1]/div[1]/div/div[1]/div[2]/div/div/div/table/thead/tr[2]/th[4]/div/div')
...
def update_google_sheets(data):
    ...
    sheet = client.open_by_url('https://docs.google.com/spreadsheets/d/1wj7LJM_RFwf1ZMOIPAAwG2Ax8yAHYCQA6gN-ITlKv3Q').worksheet("Dados prod")
    ...
    if 2 <= row_number <= 25:
        cell_range = f'B{row_number}:D{row_number}'
        values = [data]
